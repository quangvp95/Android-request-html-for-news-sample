...
//            adapter.setCurrentItem(viewModel.getCurrentPosition(), false);
//            recyclerView.getLayoutManager()
    ...
    static class CCNArticleDetailHolder extends RecyclerView.ViewHolder {
        TextView textTitle;
        TextView textUrl;
        ...
        public void setupClickableViews(RecyclerActionListener actionListener) {
            View.OnClickListener listener = v -> actionListener.onViewClick(getAbsoluteAdapterPosition(), v,
